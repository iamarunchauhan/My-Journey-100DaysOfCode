...
public class Server implements ActionListener {
	...
	Server(){
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chattingapp/icons/me1.png"));
		...
		JLabel l3 = new JLabel("Arun Chauhan");
		l3.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
		l3.setForeground(Color.WHITE);
		l3.setBounds(110, 15, 130, 20);
		p1.add(l3);
		
		JLabel l4 = new JLabel("Active Now");
		l4.setFont(new Font("SAN_SERIF", Font.PLAIN, 14));
		l4.setForeground(Color.WHITE);
		l4.setBounds(110, 35, 120, 20);
		p1.add(l4);
	...
	public void sendTextToFile(String message) throws FileNotFoundException {
		try (	
			FileWriter f = new FileWriter("chatmessages.txt");
			PrintWriter p = new PrintWriter(new BufferedWriter(f));)
		{
			p.println("Arun Chauhan :"+message);
