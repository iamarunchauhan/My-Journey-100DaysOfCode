...
public class Client implements ActionListener {
	...
	Client(){
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chattingapp/icons/linkedin1.png"));
		...
		JLabel l3 = new JLabel("Linkedin Community");
	...
	public void sendTextToFile(String message) throws FileNotFoundException {
		...
		{
			p.println("Linked Community :"+message);
